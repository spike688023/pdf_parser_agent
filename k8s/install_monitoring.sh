...
echo "👉 /opt/homebrew/share/google-cloud-sdk/bin/kubectl port-forward svc/monitoring-grafana 3000:80 -n monitoring"
echo "Then visit: http://localhost:3000 (User: admin / prom-operator)"
echo ""
echo "To access Prometheus, run this command:"
echo "👉 /opt/homebrew/share/google-cloud-sdk/bin/kubectl port-forward svc/monitoring-prometheus 9090:9090 -n monitoring"
